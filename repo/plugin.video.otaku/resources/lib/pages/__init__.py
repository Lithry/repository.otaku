...
from resources.lib.pages import nyaa, animetosho, nekobt, torrentio, debrid_cloudfiles, easynews, animepahe, anikoto, watchnixtoons2, localfiles, animeav1
...
_EMBED_MODULES = (
    ...
    ('animeav1', animeav1, 'animeav1', None, False),
)
